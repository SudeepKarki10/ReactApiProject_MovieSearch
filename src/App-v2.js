...
export default function App() {
  ...
  */
  ...
  // use wrap the async function inside another function as useEffect hook cannot return the Promises that are asynchronous in nature
  // async function fetchSearchedMovies(searchedMovie) {
  ...
  /*  various types of dependencies array and there occurance
...
function Search({ setMovieSearch, fetchSearchedMovies, query, setQuery }) {
  function handleSearch() {
    console.log(query);
